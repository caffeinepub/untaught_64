    ...
    <header className="sticky top-0 z-50 border-b border-border/50 bg-background/90 backdrop-blur-sm">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6 sm:py-4">
        ...
        <nav className="flex items-center gap-3 sm:gap-4">
          <Link
            to="/glossary"
            data-ocid="nav.glossary.link"
            aria-label="Glossary"
            className="flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors p-2 -m-2 rounded-md focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:outline-none rounded-md"
          >

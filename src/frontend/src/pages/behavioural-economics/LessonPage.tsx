...
import type { Lesson, LessonSection } from "@/data/game-theory";
      ...
      <div className="px-5 py-5 space-y-4">
        ...
        {section.example && (
          <div
            ...
            style={{
              borderLeftColor: `oklch(${AMBER})`,
              backgroundColor: `oklch(${AMBER} / 0.07)`,
            }}
          >
            <p
...
export function LessonPage({ moduleId }: LessonPageProps) {
    ...
    if (isLast) {
      if (!isRead) {
        markRead(module.lessonId, {
          onSuccess: () => {
            void navigate({
              to: `/domain/behavioural-economics/module/${moduleId}/simulation`,
            });
          },
          onError: () => {
            void navigate({
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 sm:px-6 py-8 sm:py-12 accent-amber">
      <div className="mb-10">
        <BackButton
          to="/domain/behavioural-economics/modules"
          label="All modules"
        />
      </div>

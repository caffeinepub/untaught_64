      ...
      >
        <div>
          ...
          <p className="text-sm text-foreground leading-relaxed mb-3">
            You're going to estimate how long five everyday tasks take to
            complete. These are tasks almost everyone does — nothing unusual or
            specialised.
          </p>
          <p className="text-sm text-muted-foreground leading-relaxed mb-3">
            <strong className="text-foreground/80">What's at stake:</strong>{" "}
            After you submit your estimates, you'll see the actual average times
            (measured from real people completing these tasks). The gap between
            your estimates and reality reveals the planning fallacy in action.
          </p>
          <p className="text-sm text-muted-foreground leading-relaxed">
            <strong className="text-foreground/80">Your role:</strong> Enter
            your honest first instinct for each task — don't overthink it. Go
        ...
        <button
          ...
          data-ocid="be_sim5.start.button"
    ...
    <div className="space-y-5">
              ...
              {!submitted ? (
                <div className="flex items-center gap-2 pl-8">
                  <input
                    ...
                    className="w-28 rounded-md border border-border/60 bg-background px-3 py-1.5 text-sm text-foreground focus:outline-none focus:ring-1 min-h-[44px]"
      ...
      {!submitted && (
        <button
          ...
          className="w-full rounded-md px-4 py-2.5 text-sm font-semibold transition-opacity min-h-[44px]"
          style={{

      ...
      >
        <div>
          ...
          <h3 className="font-display text-xl font-semibold text-foreground mb-3">
            Three Decisions You'll Recognise
          </h3>
          <p className="text-sm text-foreground leading-relaxed mb-3">
            In each scenario below, you've already invested something — time,
            money, or effort. Now you face a choice about what to do next.
          </p>
          <p className="text-sm text-muted-foreground leading-relaxed mb-3">
            <strong className="text-foreground/80">What's at stake:</strong>{" "}
            You'll choose between continuing (to justify the past investment) or
            stopping (to cut your losses). Pay attention to what <em>pulls</em>{" "}
            you toward each choice.
          </p>
          <p className="text-sm text-muted-foreground leading-relaxed">
            <strong className="text-foreground/80">Your role:</strong> Make the
            choice that feels right in the moment. There's no single correct
            answer — but there is a rational one.
          </p>
        </div>
        <button
          type="button"
          onClick={() => setStarted(true)}
          data-ocid="be_sim3.start.button"
              ...
              {(["A", "B"] as const).map((choice) => {
                ...
                return (
                  <button
                    ...
                    className="w-full text-left px-3 py-2.5 rounded-md border text-sm transition-all duration-150 min-h-[44px]"
                    style={{
